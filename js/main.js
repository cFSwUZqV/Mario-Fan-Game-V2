...
PlayState.preload = function () {
    ...
    this.game.stage.backgroundColor = 'grey';
...
PlayState.create = function () {
    ...
    this.game.add.image(0, 0, 'background').scale.setTo(1.2, 1.2);
...
PlayState._spawnCoin = function (coin) {
    ...
    sprite.animations.add('rotate', [0, 1, 2, 3, 4, 5, 6, 7], 8, true); // 6fps, looped
